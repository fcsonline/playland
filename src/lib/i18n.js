...
export const UI = {
  en: {
    ...
    statMastered1: '1 game mastered with 3 stars',
    ...
    update: 'Update app',
    updating: 'Updating…',
    updateWhat: 'Playland keeps a copy of itself on this device so it plays offline. Tap to fetch the newest games and fixes and reload — your stars and progress stay.',
    updateHint: 'Worth a tap if a game looks stuck or out of date.',
    resetWhat: "This erases every star, all the stats, the card ratings and each game's level. It can't be undone.",
    newBadge: 'New!',
  ...
  es: {
    ...
    statMastered1: '1 juego dominado con 3 estrellas',
    ...
    updateWhat: 'Playland guarda una copia en este dispositivo para jugar sin conexión. Toca para traer los juegos y arreglos más nuevos y recargar: tus estrellas y tu progreso se mantienen.',
    updateHint: 'Útil si un juego se ve raro o desactualizado.',
    resetWhat: 'Esto borra todas las estrellas, las estadísticas, las valoraciones de las tarjetas y el nivel de cada juego. No se puede deshacer.',
    newBadge: '¡Nuevo!',
  ...
  ca: {
    ...
    statMastered1: '1 joc dominat amb 3 estrelles',
    ...
    updateWhat: 'Playland desa una còpia en aquest aparell per jugar sense connexió. Toca per portar els jocs i les millores més noves i recarregar: les teves estrelles i el teu progrés es mantenen.',
    updateHint: 'Va bé si un joc es veu estrany o desactualitzat.',
    resetWhat: 'Això esborra totes les estrelles, les estadístiques, les valoracions de les targetes i el nivell de cada joc. No es pot desfer.',
    newBadge: 'Nou!',
  ...
  fr: {
    ...
    statMastered1: '1 jeu maîtrisé avec 3 étoiles',
    ...
    updateWhat: 'Playland garde une copie sur cet appareil pour jouer hors ligne. Touche pour récupérer les nouveaux jeux et correctifs et recharger : tes étoiles et ta progression sont conservées.',
    updateHint: 'Utile si un jeu semble bloqué ou pas à jour.',
    resetWhat: "Cela efface toutes les étoiles, les statistiques, les notes des cartes et le niveau de chaque jeu. C'est irréversible.",
    newBadge: 'Nouveau !',
